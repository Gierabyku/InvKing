...
const ScheduledServices: React.FC<ScheduledServicesProps> = ({ items, clients, onEdit, onDelete, onGetAiTips }) => {
    ...
    const scheduledItems = useMemo(() => {
        let filtered = items.filter(item => !!item.nextServiceDate);
        ...
        return filtered.sort((a, b) => new Date(a.nextServiceDate!).getTime() - new Date(b.nextServiceDate!).getTime());
    ...
    const itemsToShow = scheduledItems.slice(0, visibleCount);
        ...
        <div className="pb-20">
            <div className="sticky top-[72px] bg-gray-900/80 backdrop-blur-sm z-10 p-4 mb-6 rounded-lg border border-gray-700">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-center">
                    <div className="lg:col-span-2">
                        <input
                            type="text"
                            placeholder="Wyszukaj po urządzeniu, kliencie..."
                            value={searchQuery}
            ...
            {itemsToShow.length === 0 ? (
                <div className="text-center text-gray-400 mt-20">
                    ...
                    <h2 className="text-xl font-semibold">Brak zaplanowanych serwisów</h2>
                    <p>Nie znaleziono zleceń pasujących do Twoich kryteriów.</p>
                </div>
            ) : (
                <>
